...
import 'package:yellowline/view/screens/Drivers%20Screen/add_driver_screen/driver_approvel_screen.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.push(context, MaterialPageRoute(builder: (context) => DriverApprovelScreen(),));
        },
      ),
    );
  }

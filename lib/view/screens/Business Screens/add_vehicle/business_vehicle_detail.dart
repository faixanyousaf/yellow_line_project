...
import 'package:yellowline/view/screens/Business%20Screens/add_vehicle/business_vehicle_added.dart';

class BusinessVehicleDetail extends StatefulWidget {
  const BusinessVehicleDetail({Key? key}) : super(key: key);

  @override
  State<BusinessVehicleDetail> createState() => _BusinessVehicleDetailState();
}

class _BusinessVehicleDetailState extends State<BusinessVehicleDetail> {
  @override
